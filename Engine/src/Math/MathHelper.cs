...
public static class MathHelper
{
    ...
    // public static Vector3 ToAxisAngle(this TK.Quaternion value, out float angle)
    // {
    ...
    //         value = TK.Quaternion.Normalize(value);
    ...
    // public static Vector3 ToEulerAngles(this TK.Quaternion value)
    // {
